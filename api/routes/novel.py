    ...
    steps = [
        {
            ...
            "sequence": 1,
            "status": "done" if world_rules_context else "skipped",
        ...
        },
        {
            ...
            "sequence": 2,
            "status": "done" if character_states else "skipped",
        ...
        },
        {
            ...
            "label": "PlotAgent",
            "sequence": 3,
            "status": "done" if raw_scene_draft else "skipped",
        ...
        },
        {
            ...
            "sequence": 5,
            "status": "done" if final_prose else "skipped",
